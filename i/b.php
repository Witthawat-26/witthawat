...
<head>
<meta charset="utf-8">
<title>วิทวัส วงศ์ภาคำ</title>
</head>

<body>
<h1> สวัสดี งาน i -- วิทวัส วงศ์ภาคำ (เกม) </h1>
...
?>
    ...
    onclick="return confirm('คุณต้องการลบข้อมูลนี้หรือไม่')"><img src="images/delete.jpg" width="25" height="25"></td>
    </tr>
<?php
}
?>
